...
export default class ProductList {
    ...
    constructor(category, dataSource, listElement) {
      ...
      renderList(list) {
        ...
        const PricedList = list.filter(item => item.FinalPrice < 200 && item.FinalPrice >177);
        renderListWithTemplate(template, this.listElement, PricedList, this.prepareTemplate);  
      }
